...
exports.namazDataShafi = exports.namazDataHanefi = exports.namazData = void 0;
...
exports.namazDataHanefi = namazDataHanefi;
...
exports.namazDataShafi = namazDataShafi;
const namazData = (lang) => {
    if (lang === 'id') {
        return namazDataShafi;
    }
    return namazDataHanefi;
};
exports.namazData = namazData;
