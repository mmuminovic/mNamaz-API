...
export const ustajanjeNaTreciRekat = [
    {
...
export const ustajanjeNaSledeciRekat = [
    {
        title: 'ustajanje_na_sljedeci_rekat',
        data: [
            {
